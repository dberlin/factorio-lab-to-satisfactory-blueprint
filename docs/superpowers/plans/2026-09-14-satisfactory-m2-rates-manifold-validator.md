...
3. **Not in M2 (user ruling 2026-09-15 03:12 UTC): using lifts inside the manifold laying.** The manifold template is not extended further; M3 opens with the grid-routed packer and 3D router, which use the lift primitive from item 2 (a lift as a vertical edge, a lift straight into a port with any top yaw, two lifts as a U-turn), raced against the manifold.
